...
Jay is currently in a servant leader role at Faction. At Faction, Jay helps support the sucess of global clientele taking advantage of Faction's Cloud Data Services for Multi-Cloud backed by Cloud Control Volumes™ (CCV™) and Hybrid Disaster Recovery-as-a-Service (HDRaaS) products enabled by a growing number of patents.
